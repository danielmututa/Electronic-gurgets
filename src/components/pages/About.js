...
const cards = [
  ...
  return (
    <div className='py-[80px] flex flex-col px-[100px]'>

        <div className="flex justify-between  ">

        <div className="flex-col flex w-[46%] gap-4">
            <div className="flex justify-between">
 ...
 <img loading='lazy' src={abt2} className='w-[48%] h-[200px] object-cover' alt="" />
     ...
     <div className="flex justify-center flex-col w-[46%]">
        <h4 className="text-buttons py-2 font-montserrat">WHY ARE WE?</h4>
        <h2 className='text-[26px] font-montserratBold'>Empowering Innovation in Electronics and Technology</h2>

        <p className='text-[18px] font-montserrat py-2'>At TechRevive, we believe in empowering innovation, advancing 
          ...
          <div className="flex justify-between pt-10">
                 {
                    cards.map((card,index)=>(
                        <div className="w-[30%] flex justify-between gap-2 ">
